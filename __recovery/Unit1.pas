...
begin
    ...
    raise Exception.Create('Потеряна связь с ККМ, состояние документа неизвестно'); {  begin
...
// False - Документ не закрылся. Требуется его отменить (если это чек) и сформировать заново
